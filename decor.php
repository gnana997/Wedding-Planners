...
<div class="banner">
		...
		<div class="container" style="background: none;">
			<h3 class="w3layouts_head" style="color:#fff">Decorators Available</h3>
			<p class="w3_para"> The following are the decorating services we offer. Press to add to your cart. The amount will be automatically added to your cart!</p>
				<div class="agile-ser-tp">
                    <form action="decor.php" method="POST">
					<div class="col-md-4 w3-lft">
						<div class="w3agile_special_deals_grid_left_grid" height = "60" width = "100">
							<img src="images/19.jpg" class="img-responsive" alt="">
						</div>
						<h4 style="color:#fff;text-align:center"><?php $name = "Grace Flowers Decors"; echo $name; ?></h4>
                        <h5 style="color:#fff;text-align:center;font-family: serif"><?php $cost = "10000"; echo "Cost: &#8377;".$cost;?> </h5>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name1 = "Big Impression"; echo $name1;?></h4>
                        <h5 style="color:#fff;text-align:center;font-family: serif"><?php $cost1 = "15000"; echo "Cost: &#8377;".$cost1;?></h5>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name2 = "Kareem’s Decor Services"; echo $name2;?></h4>
						<h5 style="color:#fff;text-align:center;font-family: serif"><?php $cost2 = "30000"; echo "Cost: &#8377;".$cost2;?></h5>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name3 = "Kurinji Flower Decorators"; echo $name3;?></h4>
						<h5 style="color:#fff;text-align:center;font-family: serif"><?php $cost3 = "15000"; echo "Cost: &#8377;".$cost3;?></h5>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name4 = "Arora Flower Decorators"; echo $name4;?></h4>
						<h5 style="color:#fff;text-align:center;font-family: serif"><?php $cost4 = "25000"; echo "Cost: &#8377;".$cost4;?></h5>
