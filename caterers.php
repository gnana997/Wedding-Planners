...
<div class="banner">
		...
		<div class="container" style="background: none;">
			<h3 class="w3layouts_head" style="color:#fff">Caterers Available</h3>
...
assumenda est, omnis dolor repellendus.</p>
				<div class="agile-ser-tp">
					...
					<div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name = "Ahuja Catering Services"; echo $name; ?></h4>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name1 = "Darling Catering Services"; echo $name1;?></h4>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name2 = "Kareem’s Catering Services"; echo $name2;?></h4>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name3 = "Ghate’s Catering Services"; echo $name3;?></h4>
                    ...
                    <div class="col-md-4 w3-lft">
						...
						<h4 style="color:#fff;text-align:center"><?php $name4 = "Arora Catering Services"; echo $name4;?></h4>
